...
class TestDependencyWithRepository(unittest.TestCase):
    """DependencyWithRepository unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DependencyWithRepository:
        """Test DependencyWithRepository
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DependencyWithRepository`
        """
        model = DependencyWithRepository()
        if include_optional:
            return DependencyWithRepository(
                id = 56,
                package_name = '',
                ecosystem = '',
                requirements = '',
                ...
                direct = True,
                optional = True,
                repository = ecosyste_ms_cli.clients.repos.models.repository.Repository(
                    id = 56, 
                    uuid = '', 
                    full_name = '', 
                    owner = '', 
                    ...
                    host = ecosyste_ms_cli.clients.repos.models.host.Host(
                        ...
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ), ),
                manifest = ecosyste_ms_cli.clients.repos.models.manifest.Manifest(
                    ecosystem = '', 
                    filepath = '', 
                    sha = '', 
                    kind = '', 
    ...
    def testDependencyWithRepository(self):
        """Test DependencyWithRepository"""
