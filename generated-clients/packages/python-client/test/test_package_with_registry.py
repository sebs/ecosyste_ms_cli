...
class TestPackageWithRegistry(unittest.TestCase):
    """PackageWithRegistry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PackageWithRegistry:
        """Test PackageWithRegistry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PackageWithRegistry`
        """
        model = PackageWithRegistry()
        if include_optional:
            return PackageWithRegistry(
                id = 56,
                name = '',
                ecosystem = '',
                description = '',
                ...
                critical = True,
                registry = ecosyste_ms_cli.clients.packages.models.registry.Registry(
                    name = '', 
                    url = '', 
                    ecosystem = '', 
                    default = True, 
    ...
    def testPackageWithRegistry(self):
        """Test PackageWithRegistry"""
