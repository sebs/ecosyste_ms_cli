...
class TestKeywordWithPackages(unittest.TestCase):
    """KeywordWithPackages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeywordWithPackages:
        """Test KeywordWithPackages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeywordWithPackages`
        """
        model = KeywordWithPackages()
        if include_optional:
            return KeywordWithPackages(
                name = '',
                packages_count = 56,
                packages_url = '',
                related_keywords = [
                    ecosyste_ms_cli.clients.packages.models.keyword.Keyword(
                        name = '', 
                        packages_count = 56, 
                        packages_url = '', )
                    ],
                packages = [
                    ecosyste_ms_cli.clients.packages.models.package.Package(
                        id = 56, 
                        name = '', 
                        ecosystem = '', 
                        description = '', 
                        ...
                        documentation_url = '', 
                        install_command = '', 
                        metadata = ecosyste_ms_cli.clients.packages.models.metadata.metadata(), 
                        repo_metadata = ecosyste_ms_cli.clients.packages.models.repo_metadata.repo_metadata(), 
                        ...
                        rankings = ecosyste_ms_cli.clients.packages.models.rankings.rankings(), 
                        purl = '', 
                        advisories = [
    ...
    def testKeywordWithPackages(self):
        """Test KeywordWithPackages"""
