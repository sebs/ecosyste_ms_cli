...
class VersionWithPackage(BaseModel):
    """
    VersionWithPackage
    """ # noqa: E501
    id: StrictInt
    ...
    __properties: ClassVar[List[str]] = ["id", "number", "published_at", "licenses", "integrity", "status", "download_url", "registry_url", "documentation_url", "install_command", "metadata", "created_at", "updated_at", "purl", "latest", "version_url", "package_url"]
