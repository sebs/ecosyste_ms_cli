...
class Version(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "number", "published_at", "licenses", "integrity", "status", "download_url", "registry_url", "documentation_url", "install_command", "metadata", "created_at", "updated_at", "purl", "version_url", "related_tag"]
