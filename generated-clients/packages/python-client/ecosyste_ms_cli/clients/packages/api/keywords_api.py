...
class KeywordsApi:
    ...
    def get_keyword(
        self,
        keyword_name: Annotated[StrictStr, Field(description="name of keyword")],
        ...
        :param keyword_name: name of keyword (required)
    ...
    def get_keyword_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[KeywordWithPackages]:
        """get a keyword by name
    ...
    def _get_keyword_serialize(
        ...
        if keyword_name is not None:
            _path_params['keywordName'] = keyword_name
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/keywords/{keywordName}',
