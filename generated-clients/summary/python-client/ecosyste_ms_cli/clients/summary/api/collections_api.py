...
from ecosyste_ms_cli.clients.summary.api_client import ApiClient, RequestSerialized
from ecosyste_ms_cli.clients.summary.api_response import ApiResponse
from ecosyste_ms_cli.clients.summary.rest import RESTResponseType
...
class CollectionsApi:
    ...
    def get_collection(
        self,
        id: Annotated[StrictInt, Field(description="id of the collection")],
        ...
        :param id: id of the collection (required)
        :type id: int
    ...
    def get_collection_projects(
        ...
        _param = self._get_collection_projects_serialize(
            id=id,
            page=page,
            per_page=per_page,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_collection_projects_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="id of the collection")],
        page: Annotated[Optional[StrictInt], Field(description="pagination page number")] = None,
        per_page: Annotated[Optional[StrictInt], Field(description="Number of records to return")] = None,
    ...
    @validate_call
    def get_collection_projects_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="id of the collection")],
        page: Annotated[Optional[StrictInt], Field(description="pagination page number")] = None,
        per_page: Annotated[Optional[StrictInt], Field(description="Number of records to return")] = None,
    ...
    def _get_collection_projects_serialize(
        self,
        id,
        page,
        per_page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/{id}/projects',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
