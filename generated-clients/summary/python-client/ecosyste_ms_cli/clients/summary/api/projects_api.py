...
class ProjectsApi:
    ...
    def get_project(
        self,
        id: Annotated[StrictInt, Field(description="id of the project")],
    ...
    def lookup_project(
        self,
        url: Annotated[StrictStr, Field(description="url of the project")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param url: url of the project (required)
        :type url: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._lookup_project_serialize(
            url=url,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def lookup_project_with_http_info(
        self,
        url: Annotated[StrictStr, Field(description="url of the project")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def lookup_project_without_preload_content(
        self,
        url: Annotated[StrictStr, Field(description="url of the project")],
        _request_timeout: Union[
            None,
