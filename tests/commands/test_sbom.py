...
class TestSbomCommands:
    ...
    def setup_method(self):
        ...
        # Import the sbom group to ensure commands are registered
    ...
    def test_create_job(self, mock_print_output, mock_api_factory):
        ...
        mock_api_factory.call.return_value = {
            "id": "test-job-123",
            "status": "pending",
            "location": "https://sbom.ecosyste.ms/api/v1/jobs/test-job-123",
        }

        result = self.runner.invoke(
            self.sbom_group, ["create_job", "https://example.com/package.tar.gz"], obj={"timeout": 20, "format": "json"}
        )
    ...
    def test_create_job_with_polling(self, mock_sleep, mock_print_output, mock_api_factory):
        ...
        create_response = {
            "id": "test-job-789",
            "status": "pending",
            "location": "https://sbom.ecosyste.ms/api/v1/jobs/test-job-789",
        }
    ...
    def test_create_job_with_polling_multiple_status_checks(self, mock_sleep, mock_print_output, mock_api_factory):
        ...
        create_response = {
            "id": "test-job-999",
            "status": "pending",
            "location": "https://sbom.ecosyste.ms/api/v1/jobs/test-job-999",
        }
        ...
        get_response_3 = {"id": "test-job-999", "status": "completed", "results": {"dependencies": []}}
