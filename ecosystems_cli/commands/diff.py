...
def create_job(
    ...
    api_domain = get_domain_with_precedence("diff", ctx.obj.get("domain"))
    base_url = build_base_url(api_domain, "diff")
    ...
    try:
        ...
        path_params, query_params = handler.build_params("createJob", (), {"url_1": url_1, "url_2": url_2})
        ...
        if polling_interval is not None:
            ...
            if not job_id:
                ...
                if location:
                    # Extract job ID from URL like: https://diff.ecosyste.ms/api/v1/jobs/{job_id}
            ...
            while True:
                ...
                # Get job status
                handler_get = OperationHandlerFactory.get_handler("diff")
