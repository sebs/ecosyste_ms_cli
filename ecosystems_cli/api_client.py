...
class APIClient:
    ...
    def __init__(self, api_name: str, base_url: Optional[str] = None):
...
def get_client(api_name: str, base_url: Optional[str] = None) -> APIClient:
    """Get API client for specified API."""
    return APIClient(api_name=api_name, base_url=base_url)
